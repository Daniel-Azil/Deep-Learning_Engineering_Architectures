...
# use cv2 to utilize the webcam to video capture
# add the index of the webcam to use in cv2.VideoCapture() parameter.
# 0 index for the default webcam, 1, 2, 3, etc, for relatively connected webcams.
